        ...
        public static void init() {
                ...
                for (int i = 0; i < 5; i++) {
                        enemyDeathImages[i] = new Image[] {
                                        ...
                                        Load.image("敌机" + (i + 1) + "爆炸3.png"), Load.image("敌机" + (i + 1) + "爆炸4.png"),
                                        Load.image("敌机" + (i + 1) + "爆炸5.png")
                        };
                }
                // 加载BOSS图片
                ...
                for (int i = 0; i < 2; i++) {
                        bossDeathImages[i] = new Image[] {
                                        Load.image("BOSS" + (i + 1) + "爆炸1.png"),
                                        Load.image("BOSS" + (i + 1) + "爆炸2.png"),
                                        Load.image("BOSS" + (i + 1) + "爆炸3.png"),
                                        Load.image("BOSS" + (i + 1) + "爆炸4.png"),
                                        Load.image("BOSS" + (i + 1) + "爆炸5.png"),
                        };
                }
                buff = new Image[][] {
